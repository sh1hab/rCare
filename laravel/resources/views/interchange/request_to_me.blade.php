    ...
    <div class="row">        
        <div class="col-md-12">
            <div class="br-section-wrapper" style="overflow-x:auto;">
                <div class="row">
                    <div class="col-md-6">
                        <h6 class="tx-inverse tx-uppercase tx-bold tx-14 mg-b-10"> All Request To Me </h6>
                    </div>
                    <div class="col-md-6">
                            ...
                            @foreach($data['interchange_details'] as $interchange)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-oblong btn-sm btn-primary"> Accept </button>
                                        <button class="btn btn-oblong btn-sm btn-danger"> Cancel </button>
                                    </td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
                                <td colspan="9" class="text-center"> There is no reqeust to me </td>
                            </tr>
                        @endif
                    </tbody>
                </table>
