            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <input class="form-control short" type="text" name="short_name" placeholder="Enter Bank Short Name" required="">
                    </div>
                </div><!-- col-4 -->
            </div><!-- row -->
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <input class="form-control full" type="text" name="full_name" placeholder="Enter Bank Full Name" required="">
                    </div>
                </div><!-- col-4 -->
            </div><!-- row -->
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control opening" name="opening_balance" value="0">
